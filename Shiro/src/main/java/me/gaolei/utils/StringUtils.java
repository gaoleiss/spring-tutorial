...
public class StringUtils {
     ...
     * @throws java.io.UnsupportedEncodingException
     */
    public static String hmacEncode(String baseString, String key) throws NoSuchAlgorithmException, InvalidKeyException, IllegalStateException,
